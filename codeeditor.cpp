...
void CodeEditor::highlightCurrentLine()
{
    ...
    if (!isReadOnly())
    {
        ...
        //Color del resaltado de la línea actual
...
void CodeEditor::lineNumberAreaPaintEvent(QPaintEvent *event)
{
    ...
    //Color de fondo para el número de líneas
    QColor backColor = QColor(Qt::gray).darker(100);
